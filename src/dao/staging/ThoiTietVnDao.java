...
public class ThoiTietVnDao {
		...
		try {
			...
			try {
				...
				if (result) {
					...
					callStmt.execute();
					System.out.println("Create staging.raw_weather_data_thoitietvn successful!");
					return true;
				} else {
					System.out.println("Create staging.raw_weather_data_thoitietvn not successful!");
					return false;
				}
			} catch (IOException e) {
				e.printStackTrace();
	...
	public static void main(String[] args) {
		ThoiTietVnDao thoiTietEduVnDao = new ThoiTietVnDao();
